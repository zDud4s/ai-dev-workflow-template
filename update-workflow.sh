...
copy_if_different "$SCRIPT_DIR/.claude/skills/orchestrate-tdd/SKILL.md" "$TARGET_DIR/.claude/skills/orchestrate-tdd/SKILL.md"
...
copy_if_different "$SCRIPT_DIR/.ai/dashboard/scripts/council_run.py" "$TARGET_DIR/.ai/dashboard/scripts/council_run.py"
