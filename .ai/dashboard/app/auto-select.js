 ...
 * candidate tables (top 3). Powered by .ai/local/ledgers/metrics.jsonl (PR 3).
 */
(function () {
  "use strict";
    ...
    try {
      ...
      if (groups.length === 0) {
        root.innerHTML =
          ...
          `<code>auto_select.enabled: true</code> to populate <code>.ai/local/ledgers/metrics.jsonl</code>.</div>`;
        return;
      }
